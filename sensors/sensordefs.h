...
#define MPU9250_READ_RATE_MS 500
...
#define TEMPERATURE_THRESHOLD 15 //celsius
#define LUMINOSITY_THRESHOLD 100 //lux
#define GROUND_AIR_PRESSURE 1012100//pascal
#define PRESSURE_DIFFERENCE 500 //pascal
#define MOVEMENT_THRESHOLD 1.5f //G
